...
[![Github release](https://img.shields.io/github/release/kartof0nix/sio-tool.svg)](https://github.com/kartof0nix/sio-tool/releases)
[![platform](https://img.shields.io/badge/platform-Windows%20%7C%20macOS%20%7C%20Linux-blue.svg)](https://github.com/kartof0nix/sio-tool/releases)
[![Go Report Card](https://goreportcard.com/badge/github.com/kartof0nix/sio-tool)](https://goreportcard.com/report/github.com/kartof0nix/sio-tool)
[![Go Version](https://img.shields.io/badge/go-%3E%3D1.18-green.svg)](https://github.com/golang)
[![license](https://img.shields.io/badge/license-MIT-%23373737.svg)](https://raw.githubusercontent.com/kartof0nix/sio-tool/main/LICENSE)
...
#### Disclaimer:
This is an small fork of [Arapak's sio-tool](https://github.com/Arapak/sio-tool/), packed with features I missed so much I implemented them myself.
## Features
...
Script in template:
  ...
  $%path%$   Path to source file (Excluding $%full%$, e.g. "/home/kartof0nix/")
 ...
 * You can download the binary file here: https://github.com/kartof0nix/sio-tool
 * Author: $%U%$
 * Time: $%Y%$-$%M%$-$%D%$ $%h%$:$%m%$:$%s%$
**/
